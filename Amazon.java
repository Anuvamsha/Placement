package com.anuvamshasa;
import java.util.*;
class Main {
    static Scanner sc = new Scanner(System.in);
    static String Admin_Id = "anu";
    static String Admin_Password = "24062002";
            ...
            if (Chooise == 1) {
                ...
                for (Create_Merchant_obj merch : Merchants) {
                    if (MerId.equals(Integer.toString(merch.M_Id))) {
                        ...
                        System.out.println("-> Merchant Name : " + merch.M_Name + " Merchant Id : " + merch.M_Id + " is Verified : " + merch.M_Verified);
                    }
                    else {
        ...
        for (int i = 0; i < Merchants.size(); i++) {
            ...
            while (enu.hasMoreElements()) {
                if (enu.nextElement().equals(product)) {
                    System.out.println("Merchant Name : " + Merchants.get(i).M_Name + "  Product Price : " + Merchants.get(i).M_Products.get(product).get(1));
                    k += 1;
                }
            }
        }
    ...
    static void List_User_Products() {
        while (true) {
            ...
            while (enu.hasMoreElements()) {
                ...
                System.out.println("-> Product Name : " + pro + " Product Count : " + All_Products.get(pro).get(0));
            }
    ...
    static void Show_Product_List(String product) {
        ...
        for (int i = 0; i < Merchants.size(); i++) {
            Enumeration enu = Merchants.get(i).M_Products.keys();
            while (enu.hasMoreElements()) {
                if (enu.nextElement().equals(product) && Integer.parseInt(Merchants.get(i).M_Products.get(product).get(0)) > 0) {
                    System.out.println("-> Merchant Name : " + Merchants.get(i).M_Name + " Merchant Id : " + Merchants.get(i).M_Id + " Product Count : " + Merchants.get(i).M_Products.get(product).get(0) + "  Product Price : " + Merchants.get(i).M_Products.get(product).get(1));
                    k += 1;
                }
            }
        }
            ...
            for (int i = 0; i < Merchants.size(); i++) {
                if (Integer.toString(Merchants.get(i).M_Id).equals(M_Id)) {
                    ...
                    if (Integer.parseInt(Merchants.get(i).M_Products.get(product).get(0)) >= count) {
                        List<String> arr = new ArrayList<>();
                        arr.add(Integer.toString(Integer.parseInt(Merchants.get(i).M_Products.get(product).get(0)) - count));
                ...
                try {
                    ...
                    if (count <= Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(0))) {
                        if (Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(0)) > 0) {
                            if (count * Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(1)) <= User_List.get(Current_User).U_Money) {
                                List<String> arr = new ArrayList<>();
                                arr.add(Integer.toString(Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(0)) - count));
                                ...
                                User_List.get(Current_User).U_Buy.add(java.time.LocalDateTime.now() + " ---Buy--- " + product + " ---Price--- " + count * Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(1)));
                                User_List.get(Current_User).U_Money -= (count * Integer.parseInt(User_List.get(Current_User).U_Cart.get(product).get(1)));
    ...
    static void Wallet() {
        while (true) {
            ...
            int ch = sc.nextInt();
            if (ch == 1) {
                System.out.println("User Name : " + User_List.get(Current_User).U_Name + "\nAvailable Balance : " + User_List.get(Current_User).U_Money);
            }
            else if (ch == 2) {
                System.out.println("Enter the Amount : ");
                int amount = sc.nextInt();
                User_List.get(Current_User).Statement.add(java.time.LocalDateTime.now() + "---Deposit---" + (amount + User_List.get(Current_User).U_Money));
